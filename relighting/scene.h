...
const Sphere spheres[] = {
	...
	Sphere(20,Vec(65, 20, 40),           Color(),      Color(0.25, 0.75, 0.25), REFLECTION_TYPE_DIFFUSE), // 緑球
//	Sphere(10,Vec(24, 10, 80),           Color(),      Color(0.25, 0.75, 0.25), REFLECTION_TYPE_DIFFUSE), // 緑球
